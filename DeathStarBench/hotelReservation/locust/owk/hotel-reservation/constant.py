...
UTILS_DIR = f"{HOME_DIR}/DeathStarBench/hotelReservation/locust/owk/hotel-reservation/utils"
...
WHISK_API_GATEWAY = os.environ.get(
    "WHISK_API_GATEWAY", WHISK_API_GATEWAY_DEFAULT)
