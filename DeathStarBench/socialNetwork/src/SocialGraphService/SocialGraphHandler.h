...
void SocialGraphHandler::GetFollowers(
  ...
  std::cout << "[FunctionLog]: GetFollowers," << input_hash << "," << output_hash << "," << duration.count() << std::endl;
...
void SocialGraphHandler::GetFollowees(
  ...
  input_hash = str_hash(input_str);
  output_hash = str_hash(output_str);
  std::cout << "[FunctionLog]: GetFollowees," << input_hash << "," << output_hash << "," << duration.count() << std::endl;
