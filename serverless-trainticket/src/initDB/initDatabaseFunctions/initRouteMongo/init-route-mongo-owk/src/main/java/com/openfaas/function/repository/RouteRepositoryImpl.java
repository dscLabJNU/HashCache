...
public class RouteRepositoryImpl implements RouteRepository {
    ...
    @Override
    public boolean init(ArrayList<RouteInfo> routeInfos) {
        try {
            for (RouteInfo routeInfo : routeInfos) {
                // System.out.println(routeInfo.getId());
                // System.out.println(routeInfo.getStartStation());
                // System.out.println(routeInfo.getEndStation());
                // System.out.println(routeInfo.getStationList());
                // System.out.println(routeInfo.getDistanceList());
                Document doc1 = new Document(JsonUtils.object2Map(RouteInfo2Route(routeInfo)));
